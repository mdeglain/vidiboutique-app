...
import { ProfilContent, SettingsContent, AddressesContent, DefaultOrdersList } from "./components"
        ...
        <ProfilWrapper>
            ...
            <Wrapper>
                <Navbar>
                    ...
                    <NavbarElement onClick={() => setActivePage("default-orders")} isActive={activePage === "default-orders"}>Commandes par défaut</NavbarElement>
                </Navbar>
                <Content>
                    {activePage === 'profil' && <ProfilContent />}
                    {activePage === 'orders' && <OrdersList isAdmin={false} />}
                    {activePage === 'addresses' && <AddressesContent />}
                    {activePage === 'settings' && <SettingsContent />}
                    {activePage === 'default-orders' && <DefaultOrdersList />}
                </Content>
            </Wrapper>
        </ProfilWrapper>
    )
